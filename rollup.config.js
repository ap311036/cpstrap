...
libConfig.output = [
  { sourcemap: true, name: 'Cpstrap', file: 'dist/cpstrap.cjs.js', format: 'cjs' },
  { sourcemap: true, name: 'Cpstrap', file: 'dist/cpstrap.es.js', format: 'es' },
];
...
umdFullConfig.output = [
  { globals: globals(), sourcemap: true, name: 'Cpstrap', file: 'dist/cpstrap.full.js', format: 'umd' },
];
...
umdFullConfigMin.output = [
  { globals: globals(), sourcemap: true, name: 'Cpstrap', file: 'dist/cpstrap.full.min.js', format: 'umd' },
];
...
umdConfig.output = [
  { globals: allGlobals, sourcemap: true, name: 'Cpstrap', file: 'dist/cpstrap.js', format: 'umd' },
];

const umdConfigMin = baseUmdConfig(true);
umdConfigMin.external = external;
umdConfigMin.output = [
  { globals: allGlobals, sourcemap: true, name: 'Cpstrap', file: 'dist/cpstrap.min.js', format: 'umd' },
];
